...
public class GpsModuleRandomValues extends Fault{
	...
	public GpsModuleRandomValues(int timeStartInjWindow, int timeEndInjWindow, int timeEndInjRun, int numberOfFaults,
