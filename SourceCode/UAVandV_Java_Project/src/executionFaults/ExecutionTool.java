...
public class ExecutionTool {
	...
	public ExecutionTool(String faultsFilePath) {
	...
	public void RunLocalTest() {
	    ...
	    String[] command = {
	            "/bin/bash",
	            "-c",
	            "gnome-terminal -- bash -c 'cd /home/anamta/DronekitScript && python3.8 AutoRunsShort.py; exec bash'"
	        };
	    
//	    String[] commandb = {
//	            "/bin/bash",
//	            "-c",
//	            "cd /home/anamta/DronekitScript && python3.8 AutoRunsShort.py"
//	        };
        try {        
        	// Execute the command
